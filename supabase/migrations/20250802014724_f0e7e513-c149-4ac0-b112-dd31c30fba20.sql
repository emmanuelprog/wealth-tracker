...
INSERT INTO public.categories (user_id, name, icon, color, is_default) VALUES
  ('00000000-0000-0000-0000-000000000000', 'Food & Dining', '🍽️', '#10B981', true),
  ('00000000-0000-0000-0000-000000000000', 'Transportation', '🚗', '#3B82F6', true),
  ('00000000-0000-0000-0000-000000000000', 'Shopping', '🛒', '#8B5CF6', true),
  ('00000000-0000-0000-0000-000000000000', 'Entertainment', '🎬', '#F59E0B', true),
  ('00000000-0000-0000-0000-000000000000', 'Bills & Utilities', '⚡', '#EF4444', true),
  ('00000000-0000-0000-0000-000000000000', 'Healthcare', '🏥', '#06B6D4', true),
  ('00000000-0000-0000-0000-000000000000', 'Income', '💰', '#22C55E', true),
  ('00000000-0000-0000-0000-000000000000', 'Savings', '🏦', '#6366F1', true);
...
BEGIN
  ...
  SELECT NEW.id, name, icon, color, false
